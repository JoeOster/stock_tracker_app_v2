...
INSERT OR IGNORE INTO account_holders (id, name) VALUES (3, 'Test 2');
INSERT OR IGNORE INTO account_holders (id, name) VALUES (4, 'Test 3');
INSERT OR IGNORE INTO account_holders (id, name) VALUES (5, 'Test 4');
INSERT OR IGNORE INTO account_holders (id, name) VALUES (6, 'Test 5');

-- === Advice Sources (1 per test user) ===
INSERT INTO advice_sources (account_holder_id, name, type, description) VALUES
(2, 'Source A', 'Website', 'Financial News Site'),
(3, 'Source B', 'Person', 'Investment Advisor'),
(4, 'Source C', 'Book', 'Classic Investing Book'),
(5, 'Source D', 'Service', 'Subscription Newsletter'),
(6, 'Source E', 'Group', 'Local Investment Club');

-- === Transactions (5 BUYs on 2025-10-10 + 5 BUYs per day for 2025-10-13 to 2025-10-17 = 30 total) ===
-- Tickers: AAPL, MSFT, GOOG, AMZN, TSLA, NVDA, META, JNJ, V, JPM
-- Dates: 2025-10-10 (Fri), 2025-10-13 (Mon), 2025-10-14 (Tue), 2025-10-15 (Wed), 2025-10-16 (Thu), 2025-10-17 (Fri)

-- Account Holder 2 (Test 1)
...
-- === Account Snapshots (9 total, spread across users/exchanges) ===
-- Past Fridays: 2025-09-19, 2025-09-26, 2025-10-03, 2025-10-10
-- Today (Last Trading Day): 2025-10-17
-- Future Fridays (using placeholders - values won't affect calculations much): 2025-10-24, 2025-10-31, 2025-11-07, 2025-11-14
...
('Fidelity', '2025-10-17', 2050.00, 6), -- Today
('Robinhood', '2025-10-24', 2400.00, 2), -- Future Placeholder
('E-Trade', '2025-10-31', 1700.00, 3), -- Future Placeholder
('Other', '2025-11-07', 2150.00, 4), -- Future Placeholder
('Fidelity', '2025-11-14', 2250.00, 5); -- Future Placeholder


-- === Journal Entries (5 Open, 3 Closed - with historical dates) ===
-- Open (Dated up to 2025-10-17)
INSERT INTO journal_entries (account_holder_id, entry_date, ticker, exchange, direction, quantity, entry_price, target_price, stop_loss_price, status, advice_source_id) VALUES (2, '2025-10-13', 'JPM', 'Fidelity', 'BUY', 10, 155.00, 165.00, 150.00, 'OPEN', (SELECT id FROM advice_sources WHERE account_holder_id=2 LIMIT 1));
INSERT INTO journal_entries (account_holder_id, entry_date, ticker, exchange, direction, quantity, entry_price, target_price, stop_loss_price, status) VALUES (3, '2025-10-14', 'META', 'Robinhood', 'BUY', 5, 338.00, 355.00, 330.00, 'OPEN');
INSERT INTO journal_entries (account_holder_id, entry_date, ticker, exchange, direction, quantity, entry_price, target_price, stop_loss_price, status, advice_source_id) VALUES (4, '2025-10-15', 'V', 'E-Trade', 'BUY', 8, 224.00, 235.00, 220.00, 'OPEN', (SELECT id FROM advice_sources WHERE account_holder_id=4 LIMIT 1));
INSERT INTO journal_entries (account_holder_id, entry_date, ticker, exchange, direction, quantity, entry_price, target_price, stop_loss_price, status) VALUES (5, '2025-10-16', 'JNJ', 'Other', 'BUY', 20, 160.00, 170.00, 157.00, 'OPEN');
INSERT INTO journal_entries (account_holder_id, entry_date, ticker, exchange, direction, quantity, entry_price, target_price, stop_loss_price, status, advice_source_id) VALUES (6, '2025-10-17', 'AAPL', 'Fidelity', 'BUY', 5, 176.00, 185.00, 172.00, 'OPEN', (SELECT id FROM advice_sources WHERE account_holder_id=6 LIMIT 1));
-- Closed (Ensure exit dates are <= 2025-10-17)
INSERT INTO journal_entries (account_holder_id, entry_date, ticker, exchange, direction, quantity, entry_price, status, exit_date, exit_price, pnl, advice_source_id) VALUES (2, '2025-09-01', 'TSLA', 'Fidelity', 'BUY', 2, 680.00, 'CLOSED', '2025-09-15', 720.00, 80.00, (SELECT id FROM advice_sources WHERE account_holder_id=2 LIMIT 1));
INSERT INTO journal_entries (account_holder_id, entry_date, ticker, exchange, direction, quantity, entry_price, status, exit_date, exit_price, pnl) VALUES (4, '2025-09-05', 'AMZN', 'E-Trade', 'BUY', 1, 3250.00, 'CLOSED', '2025-09-20', 3150.00, -100.00);
INSERT INTO journal_entries (account_holder_id, entry_date, ticker, exchange, direction, quantity, entry_price, status, exit_date, exit_price, pnl) VALUES (6, '2025-09-10', 'NVDA', 'Robinhood', 'BUY', 5, 200.00, 'CLOSED', '2025-09-25', 215.00, 75.00);

-- === Pending Orders (1 per test user, created before 2025-10-17) ===
...
-- === Watchlist (5 total, spread) ===
INSERT INTO watchlist (account_holder_id, ticker) VALUES (2, 'CRM');
INSERT INTO watchlist (account_holder_id, ticker) VALUES (3, 'DIS');
INSERT INTO watchlist (account_holder_id, ticker) VALUES (4, 'PYPL');
INSERT INTO watchlist (account_holder_id, ticker) VALUES (5, 'SQ');
INSERT INTO watchlist (account_holder_id, ticker) VALUES (6, 'UBER');

-- === Notifications (5 total, spread - created historically) ===
