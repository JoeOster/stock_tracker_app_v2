  ...
  if (isSingleLot && singleLot) {
    ...
    footerHTML = `
            <div class="action-buttons">
                <button class="sell-position-btn" data-ticker="${ticker}" data-exchange="${exchange}" data-lots="${encodedLots}">Sell</button>
                <button class="edit-position-btn" data-ticker="${ticker}" data-exchange="${exchange}" data-lots="${encodedLots}">Edit</button>
                <button class="manage-position-btn" disabled>Manage</button>
            </div>
        `;
    // --- MODIFICATION END ---
  } else {
  ...
  return `
        <tr data-lot-id="${lot.id}" data-key="lot-${lot.id}">
            ...
            <td class="center-align actions-cell sticky-col col-actions">
                <button class="sell-position-btn" data-ticker="${lot.ticker}" data-exchange="${lot.exchange}" data-lots="${encodedLots}">Sell</button>
                <button class="edit-position-btn" data-ticker="${lot.ticker}" data-exchange="${lot.exchange}" data-lots="${encodedLots}">Edit</button>
                <button class="manage-position-btn" disabled>Manage</button>
            </td>
        </tr>
    `;
