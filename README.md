...
* **Refactored Codebase:** Both the backend and frontend have been refactored into smaller, modular files for improved organization and maintainability.  
* **Environment-Specific Databases & Deployment:** The project uses separate databases for development, testing, and production, with an automated deployment script for Windows services.
